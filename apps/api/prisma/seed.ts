...
const ROLE_PERMISSIONS: Record<SystemRoleCode, string[]> = {
  ...
  WAREHOUSE_EMPLOYEE: [PERMISSIONS.PRODUCTS_READ, PERMISSIONS.PRODUCTS_UPDATE, PERMISSIONS.ORDERS_READ],
  DELIVERY_DRIVER: [PERMISSIONS.ORDERS_READ, PERMISSIONS.PAYMENTS_CREATE, PERMISSIONS.PAYMENTS_READ],
