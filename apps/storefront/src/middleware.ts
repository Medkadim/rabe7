...
const PROTECTED_PREFIXES = ["/catalog", "/cart", "/orders", "/account", "/favorites", "/promotions"];
...
export const config = {
  matcher: ["/catalog/:path*", "/cart/:path*", "/orders/:path*", "/account/:path*", "/favorites/:path*", "/promotions/:path*"],
};
